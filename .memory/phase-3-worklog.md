...
`raqam/server` is an alias for `raqam/core` — zero DOM deps, works in Node.js/Edge runtimes.
...
| -------------- | ---------- | ------------------------------------------------------------------------------------ |
| `raqam/core`   | 1.8 KB     | ~2.1 KB (+presets, +accounting parser)                                               |
| `raqam` (full) | 6.3 KB     | ~8.0 KB (+validate, +IME, +rawValue, +formatValue/parseValue, +useNumberFieldFormat) |
